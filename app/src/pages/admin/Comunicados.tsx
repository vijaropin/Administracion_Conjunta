...
export function Comunicados() {
  ...
  const { comunicados, fetchComunicados, createComunicado } = useComunicacionStore();
  ...
  const handleCreateComunicado = async () => {
    ...
    await createComunicado({
      ...
      torreDestino: newComunicado.torreDestino || undefined,
      unidadDestino: newComunicado.unidadDestino || undefined,
      leidoPor: []
    });
