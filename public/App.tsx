...
function ProtectedRoute({ children, allowedTypes }: { children: React.ReactNode; allowedTypes: string[] }) {
  ...
  const residentLikeTypes = ['residente', 'propietario_residente', 'arrendatario', 'propietario_no_residente'];
  ...
  if (!allowedTypes.includes(user.tipo)) {
    ...
    if (residentLikeTypes.includes(user.tipo)) return <Navigate to="/residente/dashboard" replace />;
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/residente" element={<ProtectedRoute allowedTypes={['residente', 'propietario_residente', 'arrendatario', 'propietario_no_residente']}><ResidenteLayout /></ProtectedRoute>}>
          <Route index element={<Navigate to="dashboard" replace />} />
